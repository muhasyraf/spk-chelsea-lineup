...
if (isset($_POST['update'])) {
  ...
  $sikap->update($kdpegawai, $nilai_ep, $target_ep, $selisih_ep, $nilai_bobot_ep, $nilai_ktj, $target_ktj, $selisih_ktj, $nilai_bobot_ktj, $nilai_kh, $target_kh, $selisih_kh, $nilai_bobot_kh, $nilai_db, $target_db, $selisih_db, $nilai_bobot_db, $nilai_cf_A2, $nilai_sf_A2, $nilai_tot_A2, $missing_argument);
}
