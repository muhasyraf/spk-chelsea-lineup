...
<body>
    <div class="content">
        ...
        <div id="container">
            <div id="box">
                <div class="box-top"><i>Menambahkan Nilai Right Midfielder</i></div>
                <div class="box-panel">
                    <form method="POST" action="prosesnilai_rmf.php">
                        <table class="table">
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" style="width: 140px" name="kdpemain" required>
                                        ...
                                        $db  = new database();
                                        $kon = $db->connect();
                                        $qcek = $kon->query("SELECT * FROM pm_pemain WHERE posisi='RMF'");
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" style="width: 80px" name="nilai_cf_A7" id="nilai_cf_A7" readonly>
                                </td>

                                <td style="padding-left: 40px; text-align: right">Nilai Secondary <br>Factor</td>
                                <td>
                                    <input type="text" style="width: 80px" name="nilai_sf_A7" id="nilai_sf_A7" readonly>
                                </td>

                                <td style="padding-left: 30px">Nilai Total</td>
                                <td>
                                    <input type="text" style="width: 80px" name="nilai_tot_A7" id="nilai_tot_A7">
                                </td>
                            </tr>
                            <tr>
                                <td></td>
    ...
    <script>
        ...
        function setGapCA() {
            ...
            document.getElementById("nilai_cf_A7").value = cf;
            document.getElementById("nilai_sf_A7").value = sf;
            document.getElementById("nilai_tot_A7").value = nt;
        }
    </script>
</body>
