...
<body>
  <div class="content">
    <i class="fa fa-plus-square" style="font-size: 26px;"><span style="padding-left: 15px">Input Nilai <small>&raquo; Attacking Midfielder</small></i>

  <div id="container">
      <div id="box">
        <div class="box-top"><i>Menambahkan Nilai Attacking Midfielder</i></div>
        <div class="box-panel">
					<form method="POST" action="prosesnilai_amf.php">
					<table class="table">
            <tr>
                ...
                <select class="form-control" name="kdpemain" required>
                  ...
                  <?php
                    ...
                    $db  = new database();
                    $kon = $db->connect();
                    $qcek = $kon->query("SELECT * FROM pm_pemain WHERE posisi='AMF'");
            ...
            <tr>
              ...
              <td>
                <input type="text" style="width: 80px" name="nilai_cf_A8" id="nilai_cf_A8" readonly>
              </td>

              <td style="text-align: right; padding-left: 40px">Nilai Secondary<br> Factor</td>
              <td>
                <input type="text" style="width: 80px" name="nilai_sf_A8" id="nilai_sf_A8" readonly>
              </td>

              <td style="text-align: right; padding-left: 20px">Nilai Total</td>
              <td>
                <input type="text" style="width: 80px" name="nilai_tot_A8" id="nilai_tot_A8" readonly>
              </td>
            </tr>
            <tr><td></td></tr><tr><td></td></tr>
            <tr>
              ...
              <td colspan="2"><button type="submit" class="btn-save" name="simpan">
                  ...
                  <span style="padding-left: 50px"><a href="inputnilai_amf.php" class="btn-delete">
  ...
  <script>
    ...
    function setGapDW(){
      ...
      var nt  = (cf * 0.6) + (sf * 0.4);
    	...
    	document.getElementById("nilai_cf_A8").value  = cf;
      document.getElementById("nilai_sf_A8").value  = sf;
    	document.getElementById("nilai_tot_A8").value = nt;
  	}
  </script>
