...
if (isset($_POST['update'])) {
  ...
  $perilaku->update($kdpegawai, $nilai_dm, $target_dm, $selisih_dm, $bobot_dm, $nilai_if, $target_if, $selisih_if, $bobot_if, $nilai_std, $target_std, $selisih_std, $bobot_std, $nilai_cp, $target_cp, $selisih_cp, $bobot_cp, $nilai_cf_A3, $nilai_sf_A3, $nilai_tot_A3, $missing_argument);
}
