...
if (isset($_POST['update'])) {
  ...
  $intelektual->update($kdpegawai, $nilai_vi, $target_vi, $selisih_vi, $nilai_bobot_vi, $nilai_sb, $target_sb, $selisih_sb, $nilai_bobot_sb, $nilai_kn, $target_kn, $selisih_kn, $nilai_bobot_kn, $nilai_lp, $target_lp, $selisih_lp, $nilai_bobot_lp, $nilai_ik, $target_ik, $selisih_ik, $nilai_bobot_ik, $nilai_cf_A1, $nilai_sf_A1, $nilai_tot_A1, $nilai_cf_A2); // Add the missing argument
}
