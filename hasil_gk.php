...
<head>
  <title>Penilaian Goalkeeper</title>
...
<body>
  <div class="content">
    <i class="fa fa-check-square-o" style="font-size: 28px;"><span style="padding-left: 15px;">Hasil Akhir <small>&raquo; Penilaian Goalkeeper</small></span></i>
    <h3 style="margin-top: 25px; padding-left: 10px">Nilai Profil :</h3>
    <table width=100%;>
      <?php
      $goalkeeper->tampil($cari);
      ?>
    </table>
    <br><br>
