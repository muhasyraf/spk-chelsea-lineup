...
<body>
  <div class="content">
    <i class="fa fa-plus-square" style="font-size: 26px;"><span style="padding-left: 15px">Input Nilai <small>&raquo; Left Back</small></i>

    <div id="container">
      <div id="box">
        <div class="box-top"><i>Menambahkan Nilai Left Back</i></div>
        <div class="box-panel">
          <form method="POST" action="prosesnilai_lb.php">
            <table class="table">
              <tr>
                ...
                <td>
                  <select class="form-control" style="width: 140px" name="kdpemain" required>
                    ...
                    $db  = new database();
                    $kon = $db->connect();
                    $qcek = $kon->query("SELECT * FROM pm_pemain WHERE posisi='LB'");
              ...
              <tr>
                ...
                <td>
                  <input type="text" style="width: 80px" name="nilai_cf_A2" id="nilai_cf_A2" readonly>
                </td>

                <td style="padding-left: 40px; text-align: right">Nilai Secondary <br>Factor</td>
                <td>
                  <input type="text" style="width: 80px" name="nilai_sf_A2" id="nilai_sf_A2" readonly>
                </td>

                <td style="padding-left: 30px">Nilai Total</td>
                <td>
                  <input type="text" style="width: 80px" name="nilai_tot_A2" id="nilai_tot_A2">
                </td>
              </tr>
              <tr>
                <td></td>
